...
@njit
def do_m5_intra(pos1, pos2, u_prev, u, x, x_post, v_prev, v, y, lookup, lookup_next, lookup_prev):
    # update lookup table
    m5_lookup_intra_update(pos1, pos2, u, x, v, y, lookup, lookup_next)
    # update lookup_prev, lookup_next
    m5_lookup_precedence_update(lookup_prev, lookup_next, u_prev, u, x, x_post, v_prev, v, y)
...
@njit
def m5_lookup_precedence_update(lookup_prev, lookup_next, u_prev, u, x, x_post, v_prev, v, y):
    """
